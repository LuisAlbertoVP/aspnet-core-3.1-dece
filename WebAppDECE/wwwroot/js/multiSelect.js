...
var multi = (function () {
  ...
  toggle_option = function(select, event, settings) {
  ...
  var refresh_select = function(select, settings) {
    ...
    for (var i = 0; i < select.options.length; i++) {
      ...
      row.tabIndex = 0;
      row.setAttribute("data-clave", option.getAttribute('data-clave'));
      row.setAttribute("data-clave-2", option.getAttribute('data-clave-2'));
      row.className = "item";
      row.innerText = label;
